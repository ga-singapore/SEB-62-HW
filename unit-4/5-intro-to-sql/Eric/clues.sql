...
-- Write SQL query here
SELECT * FROM countrylanguages --find all country languages
	
SELECT code, name FROM countries WHERE name = 'Holy See (Vatican City State)'; --find the VAT country code
...
-- Write SQL query here
SELECT countries.name, countrylanguages.language, countrylanguages.percentage
  FROM countries
...
-- Write SQL query here
 SELECT code FROM countries WHERE name = 'San Marino'; --find country code
SELECT name
  FROM cities
  WHERE countrycode = 'SMR' --find cities in San Marino
...
-- We're counting on you, gumshoe. Find out where she's headed, send us the info, and we'll be sure to meet her at the gates with bells on.
  ...
  FROM cities
  JOIN countries ON cities.countrycode = countries.code
  WHERE cities.population = 91085-1; -- popluation of 91,085 minus 1 because her cocky note says she's adding to the population.
